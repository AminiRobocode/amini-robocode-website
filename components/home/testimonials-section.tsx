...
const testimonials = [
  {
    ...
    text: "پسرم در کلاس‌های رباتیک امینی روبوکُد شرکت می‌کند. تغییراتی که در تمرکز و اعتمادبه‌نفس او دیدم باورنکردنی بود. واقعاً حرفه‌ای‌ترین مرکز آموزش رباتیک است.",
    rating: 5,
  },
  {
    name: "آقای رضایی",
  ...
  },
  {
    ...
    text: "پسرم اختلال یادگیری داشت. با برنامه تخصصی رفع اختلالات یادگیری امینی روبوکُد، پیشرفت چشمگیری کرده است. از تیم امینی روبوکُد بی‌نهایت سپاسگزارم.",
    rating: 5,
  },
  {
    name: "سارا موسوی",
